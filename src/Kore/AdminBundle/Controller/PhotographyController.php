...
use Kore\AdminBundle\Form\PhotographyType;
...
class PhotographyController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($sort) $photographies = $em->getRepository('KoreAdminBundle:Photography')->findBy(array(), array($sort => $direction));
        else $photographies = $em->getRepository('KoreAdminBundle:Photography')->findAll();
        ...
        return $this->render('KoreAdminBundle:Photography:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('KoreAdminBundle:Photography:new.html.twig', array(
    ...
    public function showAction(Photography $photography)
    {
        ...
        return $this->render('KoreAdminBundle:Photography:show.html.twig', array(
    ...
    public function editAction(Request $request, Photography $photography)
    {
        ...
        return $this->render('KoreAdminBundle:Photography:edit.html.twig', array(
            'photography' => $photography,
            'editForm' => $editForm->createView(),
            'deleteForm' => $deleteForm->createView(),
        ));
