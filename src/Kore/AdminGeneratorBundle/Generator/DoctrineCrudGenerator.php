...
namespace Kore\AdminGeneratorBundle\Generator;
...
class DoctrineCrudGenerator extends BaseGenerator
{
    ...
    protected function generateConfiguration()
    {
        ...
        $target = sprintf(
            '%s/../AdminBundle/Resources/config/routing/%s.%s',
            $this->bundle->getPath(),
    ...
    protected function generateControllerClass($forceOverwrite)
    {
        ...
        $target = sprintf(
            '%s/../AdminBundle/Controller/%s/%sController.php',
            $dir,
    ...
    protected function generateTestClass()
    {
        ...
        $dir = $this->bundle->getPath().'/../AdminBundle/Tests/Controller';
